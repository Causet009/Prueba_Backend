...
PELICULAS = [
    {
        "id": 1,
        "titulo": "El faro del desierto",
        "genero": "Drama",
        "precio": 4500,
        "duracion": 112,
        "estreno": False,
        "apta_todo_publico": True,
    ...
    {
        "id": 8,
        "titulo": "Noche de brujas en Mejillones",
        "genero": "Terror",
        "precio": 5000,
        "duracion": 101,
        "estreno": False,
...
def inicio(request):
    ...
    for pelicula in PELICULAS:
        suma_duracion += pelicula["duracion"]

        if pelicula["estreno"]:
            cantidad_estrenos += 1

    duracion_promedio = round(suma_duracion / len(PELICULAS))
...
def detalle(request, id):
    ...
    precio_nocturno = round(pelicula_encontrada["precio"] * 1.20)
